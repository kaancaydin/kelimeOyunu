  ...
  */
  ...
  const variants = {
    ...
    pass: `group flex items-center gap-1.5 sm:gap-3 px-3 py-1 rounded-2xl flex-row
            font-black  justify-center text-base sm:text-lg
            bg-linear-to-r from-slate-200 to-slate-300 shadow-[0_2px_0_0_#B6C3D4] sm:shadow-[0_4px_0_0_#B6C3D4]
            hover:from-slate-300 hover:to-slate-400 active:shadow-none active:translate-y-0.5 
            transition-all duration-150 ease-in-out`,
    clue: `group relative uppercase px-3 py-1.5 rounded-full font-bold 
