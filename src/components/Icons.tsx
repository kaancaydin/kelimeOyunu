...
export const FullScreenIcon = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M0 11C0 6.58172 3.58172 3 8 3C12.4183 3 16 6.58172 16 11V35C16 39.4183 12.4183 43 8 43C3.58172 43 0 39.4183 0 35V11Z" />

    <path d="M42 0C46.4183 0 50 3.58172 50 8C50 12.4183 46.4183 16 42 16H8C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0H42Z" />

    <path d="M108 82C108 86.4183 104.418 90 100 90C95.5817 90 92 86.4183 92 82V58C92 53.5817 95.5817 50 100 50C104.418 50 108 53.5817 108 58V82Z" />

    <path d="M66 93C61.5817 93 58 89.4183 58 85C58 80.5817 61.5817 77 66 77H100C104.418 77 108 80.5817 108 85C108 89.4183 104.418 93 100 93H66Z" />

    <path d="M0 82C0 86.4183 3.58172 90 8 90C12.4183 90 16 86.4183 16 82V58C16 53.5817 12.4183 50 8 50C3.58172 50 0 53.5817 0 58V82Z" />

    <path d="M42 93C46.4183 93 50 89.4183 50 85C50 80.5817 46.4183 77 42 77H8C3.58172 77 0 80.5817 0 85C0 89.4183 3.58172 93 8 93H42Z" />

    <path d="M108 11C108 6.58172 104.418 3 100 3C95.5817 3 92 6.58172 92 11V35C92 39.4183 95.5817 43 100 43C104.418 43 108 39.4183 108 35V11Z" />

    <path d="M66 0C61.5817 0 58 3.58172 58 8C58 12.4183 61.5817 16 66 16H100C104.418 16 108 12.4183 108 8C108 3.58172 104.418 0 100 0H66Z" />
  </svg>
);
